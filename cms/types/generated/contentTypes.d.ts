...
export interface ApiBottleBottle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cask: Schema.Attribute.String;
    category: Schema.Attribute.Enumeration<
      ['Limited Edition', 'Single Cask', "Distiller's Reserve", 'Discontinued']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    profile: Schema.Attribute.Component<'shared.tasting-profile', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    dateOptions: Schema.Attribute.Component<'shared.option', true>;
    dressCodeLabel: Schema.Attribute.String;
    emailLabel: Schema.Attribute.String;
    emailPlaceholder: Schema.Attribute.String;
    experienceLabel: Schema.Attribute.String;
    experienceOptions: Schema.Attribute.Component<'shared.option', true>;
    ...
    partySizeLabel: Schema.Attribute.String;
    partySizeOptions: Schema.Attribute.Component<'shared.option', true>;
    phoneLabel: Schema.Attribute.String;
    phonePlaceholder: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    selectPlaceholder: Schema.Attribute.String;
...
export interface ApiExperiencesPageExperiencesPage
  ...
  collectionName: 'experiences_page';
  info: {
    description: '';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    diningCtaLabel: Schema.Attribute.String;
    diningEyebrow: Schema.Attribute.String;
    diningImage: Schema.Attribute.Media<'images'>;
    diningText: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    pillars: Schema.Attribute.Component<'shared.experience-pillar', true>;
    pillarsEyebrow: Schema.Attribute.String;
    pillarsTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    stickyCtaLabel: Schema.Attribute.String;
    tablesideCtaLabel: Schema.Attribute.String;
    tablesideEyebrow: Schema.Attribute.String;
    tablesideImage: Schema.Attribute.Media<'images'>;
    tablesideText: Schema.Attribute.Text;
    tablesideTitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    closedNote: Schema.Attribute.String;
    copyrightText: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    designerCredit: Schema.Attribute.String;
    dressCode: Schema.Attribute.String;
    footerMotto: Schema.Attribute.String;
    ...
    reserveCtaLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Reserve Your Table'>;
    siteName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'House of Amrut'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    curatedJourneysEyebrow: Schema.Attribute.String;
    curatedJourneysTitle: Schema.Attribute.String;
    footerCtaEyebrow: Schema.Attribute.String;
    footerCtaLabel: Schema.Attribute.String;
    footerCtaSubtitle: Schema.Attribute.String;
    ...
    legacyEyebrow: Schema.Attribute.String;
    legacyText: Schema.Attribute.Text;
    legacyTitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    regionalPairingsEyebrow: Schema.Attribute.String;
    regionalPairingsText: Schema.Attribute.Text;
    regionalPairingsTitle: Schema.Attribute.String;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    tablesideLeftImage: Schema.Attribute.Media<'images'>;
    tablesideLeftLabel: Schema.Attribute.String;
    tablesideLeftTitle: Schema.Attribute.String;
    tablesideQuote: Schema.Attribute.Text;
    tablesideRightImage: Schema.Attribute.Media<'images'>;
    tablesideRightLabel: Schema.Attribute.String;
    tablesideRightTitle: Schema.Attribute.String;
    threeWays: Schema.Attribute.Component<'shared.pillar', true>;
    threeWaysEyebrow: Schema.Attribute.String;
    threeWaysTitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiJourneysPageJourneysPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    reserveCtaLabel: Schema.Attribute.String;
    sectionEyebrow: Schema.Attribute.String;
...
export interface ApiLibraryPageLibraryPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vaultBadge: Schema.Attribute.String;
    vaultEyebrow: Schema.Attribute.String;
...
export interface ApiTastingRoomPageTastingRoomPage
  ...
  info: {
    description: '';
    displayName: 'Tasting Room Page';
    pluralName: 'tasting-room-pages';
    singularName: 'tasting-room-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    downloadMenuLabel: Schema.Attribute.String;
    heroEyebrow: Schema.Attribute.String;
    heroImage: Schema.Attribute.Media<'images'>;
    heroSubtitle: Schema.Attribute.String;
    heroTitle: Schema.Attribute.String;
    ...
    pairingsTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTheHousePageTheHousePage extends Struct.SingleTypeSchema {
  collectionName: 'the_house_page';
  info: {
    description: '';
    displayName: 'The House Page';
    pluralName: 'the-house-pages';
    singularName: 'the-house-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    craftsmanshipEyebrow: Schema.Attribute.String;
    craftsmanshipTitle: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::the-house-page.the-house-page'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::bottle.bottle': ApiBottleBottle;
